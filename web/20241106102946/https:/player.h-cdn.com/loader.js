...
var loader_url = protocol+'//web.archive.org/web/20241106112245/https://player.h-cdn.com/loader.js?customer=foxnews&no_conf=true&md5=934419-ed54da7c';
var config_url = protocol+'//web.archive.org/web/20241106112245/https://player.h-cdn.com/config.js?customer=foxnews&md5=355987-759aa2f3';
var script_load_delay = +'';
var script_delay_root_only = +'';
window.spark_live_cache_seed = '1730891768418000000';
...
function load_custom_scripts(){
    ...
    {
        create_script(protocol+'//web.archive.org/web/20241106112245/https://player.h-cdn.com/loader_api_wrapper.js?customer=foxnews&no_conf=true', 'loader_api_wrapper');
...
function load_script(caller){
        ...
        !window.spark_force_loader_handled)
    {
        ...
        if (!new_url && customer)
            new_url = 'https://web.archive.org/web/20241106112245/https://player.h-cdn.com/loader.js?customer='+customer;
        if (new_url)
        {
...
playback timings (ms):
  ...
  esindex: 0.009
  cdx.remote: 15.023
  LoadShardBlock: 659.664 (6)
  PetaboxLoader3.datanode: 559.841 (7)
  PetaboxLoader3.resolve: 200.236 (2)
  load_resource: 200.318
*/